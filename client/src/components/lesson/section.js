...
class Section extends Component {
    ...
    header(){
        ...
        return (<div className={`lesson-section-header ${isSelected}`} onDoubleClick={()=>this.props.toggleEditing(this.props.sectionIndex)}>
                    <h2 onClick={()=>this.props.selectHighlight(this.props.sectionIndex)}>
